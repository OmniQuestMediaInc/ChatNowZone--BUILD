...
export const GZ_MASTER_ROSTER = {
  SHIFT_A: [
    { position: 'GZM-1',  role: 'GZM'  as StaffRole, pattern: 'FT_CORE_MON_FRI', category: 'CORE' as const },
    { position: 'GZSA-1', role: 'GZSA' as StaffRole, pattern: 'FT_CORE_MON_FRI', category: 'CORE' as const },
    { position: 'GZSA-2', role: 'GZSA' as StaffRole, pattern: 'FT_CORE_WED_SUN', category: 'CORE' as const },
    { position: 'GZSA-3', role: 'GZSA' as StaffRole, pattern: 'PT_EDGE',         category: 'EDGE' as const },
  ],
  SHIFT_B: [
    { position: 'GZAM-1', role: 'GZAM' as StaffRole, pattern: 'FT_CORE_MON_FRI', category: 'CORE' as const },
    { position: 'GZS-1',  role: 'GZS'  as StaffRole, pattern: 'FT_CORE_WED_SUN', category: 'CORE' as const },
    { position: 'GZSA-4', role: 'GZSA' as StaffRole, pattern: 'FT_CORE_MON_FRI', category: 'CORE' as const },
    { position: 'GZSA-5', role: 'GZSA' as StaffRole, pattern: 'FT_CORE_WED_SUN', category: 'CORE' as const },
    { position: 'GZSA-9', role: 'GZSA' as StaffRole, pattern: 'PT_EDGE',         category: 'EDGE' as const },
  ],
  SHIFT_C: [
    { position: 'GZS-2',   role: 'GZS'  as StaffRole, pattern: 'FT_CORE_MON_FRI', category: 'CORE' as const },
    { position: 'GZSA-6',  role: 'GZSA' as StaffRole, pattern: 'FT_CORE_MON_FRI', category: 'CORE' as const },
    { position: 'GZSA-7',  role: 'GZSA' as StaffRole, pattern: 'FT_CORE_MON_FRI', category: 'CORE' as const },
    { position: 'GZS-3',   role: 'GZS'  as StaffRole, pattern: 'PT_EDGE',         category: 'EDGE' as const },
    { position: 'GZSA-8',  role: 'GZSA' as StaffRole, pattern: 'PT_EDGE',         category: 'EDGE' as const },
    { position: 'GZSA-10', role: 'GZSA' as StaffRole, pattern: 'PT_EDGE',         category: 'EDGE' as const },
  ],
} as const;
