<!--
  STALE — 2026-04-24
  ------------------
  This document was flattened from archive/governance/CLAUDE.md during
  the 2026-04-24 Repo Prep & Cleanup run. It is retained for historical
  audit only.

  AUTHORITATIVE REPLACEMENTS (do NOT treat this file as live guidance):
    - Program governance:   PROGRAM_CONTROL/DIRECTIVES/QUEUE/OQMI_GOVERNANCE.md
    - Coding doctrine:      PROGRAM_CONTROL/DIRECTIVES/QUEUE/OQMI_SYSTEM_STATE.md
                            + root OQMI_SYSTEM_STATE.md (backlog snapshot)
    - Agent instructions:   .github/copilot-instructions.md
    - Domain glossary:      docs/DOMAIN_GLOSSARY.md
    - Requirements master:  docs/REQUIREMENTS_MASTER.md

  Do not edit this file. If content here conflicts with the
  authoritative sources above, the authoritative sources win.
-->

# Claude Code — Project Instructions (STALE — superseded 2026-04-24)
